...
export default function ProfileCard() {
    return (
        <section
            ...
            <div className="mx-auto max-w-3xl lg:py-16">
                ...
                <dl className="flex flex-col">
                    <div className="flex gap-2 align-baseline">
                        ...
                        <dt className="font-semibold leading-none text-gray-900 dark:text-white">Yidnekachew Tebeje</dt>
                    </div>
                    <div className="flex gap-2 align-center">
                        <dd className="font-light text-gray-500 dark:text-gray-400">Department</dd>
                        <dt className="font-semibold leading-none text-gray-900 dark:text-white">software engineering</dt>
                    </div>
                    <div className="flex gap-2 align-center">
                        <dd className="font-light text-gray-500  dark:text-gray-400">submission repo</dd>
                        <dt className="font-semibold leading-none text-gray-900 dark:text-white">https://hello.com</dt>
                    </div>
                </dl>
                <dl className="mt-3">
                    <dt className="mb-2 font-semibold leading-none text-gray-900 dark:text-white">bio</dt>
                    <dd className="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">Lorem ipsum dolor sit amet consectetur adipisicing elit. Hic cum tempore fuga quas totam adipisci laboriosam pariatur officia velit tenetur. Laboriosam est rem odit sit consequatur culpa quidem, asperiores fugiat.
                        Neque doloribus nobis, veritatis aspernatur dolore fugiat magnam optio nulla praesentium cupiditate quae quidem et aliquid voluptas harum facere quod inventore commodi, a repellendus quam dicta exercitationem deserunt? Sunt, doloribus?
                        Soluta eos iusto sed. Facere dolores recusandae incid
                    </dd>
                </dl>
                <div className="flex">
                    ...
                    <button type="button" className="text-white bg-slate-300 hover:bg-slate-100 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 mr-2 mb-2">
